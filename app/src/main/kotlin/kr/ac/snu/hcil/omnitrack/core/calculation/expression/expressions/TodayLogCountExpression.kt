 ...
 */
class TodayLogCountExpression(configuredContext: ConfiguredContext) : RealmLazyFunction(configuredContext, ExpressionConstants.COMMAND_TRACKER_LOG_COUNT_TODAY, 1) {
