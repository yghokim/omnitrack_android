...
class MapImageView : PlaceHolderImageView /*FutureCallback<ImageView>*/ {
    ...
    companion object {
        ...
        fun makeGoogleMapQuery(location: LatLng, zoom: Int, width: Int, height: Int): String {
            return "https://maps.googleapis.com/maps/api/staticmap?center=${location.latitude},${location.longitude}&zoom=$zoom&size=${width / 3}x${height / 3}&markers=size:small|${location.latitude},${location.longitude}&scale=2&key=${BuildConfig.GOOGLE_MAPS_API_KEY}"
        }
    }
