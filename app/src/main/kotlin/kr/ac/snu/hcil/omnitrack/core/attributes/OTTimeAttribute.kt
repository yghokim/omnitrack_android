 ...
 */
class OTTimeAttribute(objectId: String?, localKey: Int?, parentTracker: OTTracker?, columnName: String, isRequired: Boolean, settingData: Map<String, Any?>?, connectionData: String?) : OTAttribute<TimePoint>(objectId, localKey, parentTracker, columnName, isRequired, OTAttributeManager.TYPE_TIME, settingData, connectionData) {
