...
class OTMeasureFactoryManager(private val serviceManager: OTExternalServiceManager, private val itemMeasureFactoryManager: OTItemDynamicMeasureFactoryManager) {
