 ...
 */
class StarRatingInputView(context: Context, attrs: AttributeSet? = null, initialValue: Fraction? = null) : AFieldInputView<Fraction>(R.layout.input_stars, context, attrs) {
