 ...
 *
 */
class LocationInputView(context: Context, attrs: AttributeSet? = null) : AFieldInputView<LatLng>(R.layout.component_location_picker, context, attrs), OnMapReadyCallback, View.OnClickListener, GoogleMap.OnCameraIdleListener {
