...
object TimeHelper {
    ...
    val FORMAT_DAY_WITHOUT_YEAR :SimpleDateFormat by lazy{ SimpleDateFormat(OTApplication.app.resources.getString(R.string.msg_date_format_scope_day_for_week)) }
    val FORMAT_DAY_OF_WEEK_SHORT :SimpleDateFormat by lazy{ SimpleDateFormat(OTApplication.app.resources.getString(R.string.dateformat_day_of_week_short)) }
