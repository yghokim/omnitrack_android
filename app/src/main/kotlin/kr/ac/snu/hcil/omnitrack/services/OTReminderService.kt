...
class OTReminderService : WakefulService(TAG) {
    ...
    companion object {
        ...
        fun makeRemindIntent(context: Context, triggerId: String, triggerTime: Long): Intent {
        ...
        fun makeReminderAccessedIntent(context: Context, triggerId: String, trackerId: String, entryId: Long): Intent {
            return Intent(context, OTReminderService::class.java)
...
*/
        val accessPendingIntent = PendingIntent.getService(this, notiId, makeReminderAccessedIntent(this, triggerId, trackerId, entryId), PendingIntent.FLAG_UPDATE_CURRENT)
        val dismissIntent = makeReminderDismissedIntent(this, triggerId, entryId)

        val ringtone = PreferenceManager.getDefaultSharedPreferences(this).getString(SettingsActivity.PREF_REMINDER_NOTI_RINGTONE, android.provider.Settings.System.DEFAULT_NOTIFICATION_URI.toString())
        val lightColor = PreferenceManager.getDefaultSharedPreferences(this).getInt(SettingsActivity.PREF_REMINDER_LIGHT_COLOR, ContextCompat.getColor(this, R.color.colorPrimary))

        return OTTrackingNotificationFactory.makeBaseBuilder(this, reminderTime, OTNotificationManager.CHANNEL_ID_IMPORTANT)
                ...
                .setAutoCancel(false)
                .setDeleteIntent(PendingIntent.getService(this, notiId, dismissIntent, PendingIntent.FLAG_UPDATE_CURRENT))
