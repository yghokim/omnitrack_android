...
class RatingOptions {
    ...
    var leftMost: Int = 1
    var rightMost: Int = 5
    var leftLabel: String = OTApplication.app.resources.getString(R.string.msg_rating_options_leftmost_label_example)
    var middleLabel: String = ""
    var rightLabel: String = OTApplication.app.resources.getString(R.string.msg_rating_options_rightmost_label_example)
