...
class OTNumberAttribute(objectId: String?, localKey: Int?, parentTracker: OTTracker?, columnName: String, isRequired: Boolean, settingData: String?, connectionData: String?) : OTAttribute<BigDecimal>(objectId, localKey, parentTracker, columnName, isRequired, OTAttribute.TYPE_NUMBER, settingData, connectionData) {
