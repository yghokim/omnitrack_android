 ...
 */
class ImageInputView(context: Context, attrs: AttributeSet? = null) : AFieldInputView<OTServerFile>(R.layout.input_image, context, attrs), ImagePicker.ImagePickerCallback {
