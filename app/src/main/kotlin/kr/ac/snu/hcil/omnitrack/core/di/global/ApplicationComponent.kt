 ...
 */
@Singleton
@Component(modules = [ApplicationModule::class, JobDispatcherModule::class, SerializationModule::class, DesignModule::class, ExternalServiceModule::class, SystemIdentifierFactoryModule::class])
