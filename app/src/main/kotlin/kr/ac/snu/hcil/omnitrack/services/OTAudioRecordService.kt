...
class OTAudioRecordService : Service() {
        ...
        when (intent?.action) {
            INTENT_ACTION_RECORD_START -> {
                ...
                if (sessionId != null) {
                    ...
                    showNotificationView(this, remoteViews)
    ...
    private fun showNotificationView(context: Context, rv: RemoteViews?) {
        ...
        val notification = notificationBuilder.setContent(rv)
                .build()
