...
public class DragLinearLayout extends LinearLayout {
    ...
    private static Bitmap getBitmapFromView(View view) {
        ...
        Drawable shadow = ContextCompat.getDrawable(OTApplication.Companion.getApp(), R.drawable.shadow);
    ...
    protected void onSwap(View firstView, int firstPosition, View secondView, int secondPosition) {
        swapListener.onSwap(firstView, firstPosition, secondView, secondPosition);
    }
    ...
    private void onDrag(final int offset) {
        ...
        if (isBelow || isAbove) {
            ...
            if (null != swapListener) {
                onSwap(draggedItem.view, draggedItem.position, switchView, switchPosition);
