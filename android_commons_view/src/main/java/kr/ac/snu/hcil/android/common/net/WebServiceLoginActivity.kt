...
open class WebServiceLoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    protected open fun tryCancel() {
        ...
        DialogHelper.makeYesNoDialogBuilder(this, null, resources.getString(R.string.msg_confirm_cancel_and_close_process), R.string.msg_close, R.string.msg_cancel, {
